 ...
 */
public class CustomFeatureSetOnlyState extends FeatureSet {
	...
	public CustomFeatureSetOnlyState() {
	...
	public FeatureSet extract(Game game, MOVE move) {
		CustomFeatureSetOnlyState features = new CustomFeatureSetOnlyState();
	...
	private void setValues(Game game, MOVE move) {
		...
		exploreJunctions(game, node, MOVE.NEUTRAL, 0, 0);
		...
		double[] feastPath = exploreFeasts(game, node, MOVE.NEUTRAL, 0, 0, startPath);
