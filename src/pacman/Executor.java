...
{	
	...
	{
		// Play a game
		new Executor().runGameTimed(new HumanController(new KeyBoardInput()), new StandardGhosts(), true);
	}
	...
	/**
	 * Examples of ways of running games.
	 */
	/*private void examples() {
		...
		//run multiple games in batch mode.
		int numTrials=1000;
